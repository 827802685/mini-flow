/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b3f74a20dea9968119ea05844e277a60)
// Runtime types generated with workerd@1.20260907.1 2026-04-12 nodejs_compat
interface __BaseEnv_Env {
	CREDENTIALS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	PUSH: DurableObjectNamespace<import("./src/index").PushConnection>;
	FLOW_ENGINE: Workflow<Parameters<import("./src/index").FlowEngine['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PushConnection";
	}
